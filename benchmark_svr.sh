...
PYTHON_SCRIPT="/home/dawsonlan/ode-biomarker-project/benchmark_svr.py"
...
echo "Running SVR hyperparameter benchmarking script..."
python "$PYTHON_SCRIPT"

# Check if the script ran successfully
if [ $? -eq 0 ]; then
    echo "SVR benchmarking script completed successfully"
else
    echo "SVR benchmarking script failed with error code $?"
    exit 1
fi
