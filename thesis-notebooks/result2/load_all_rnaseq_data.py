...
print(f"Dynamic dataset shape: {cdk46_feature_data_dynamic.shape}")
print(f"Dynamic label shape: {cdk46_label_data_dynamic.shape}")
...
print(f"Dynamic dataset shape: {fgfr4_feature_data_dynamic.shape}")
print(f"Dynamic label shape: {fgfr4_label_data_dynamic.shape}")
