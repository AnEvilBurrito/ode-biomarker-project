#!/usr/bin/env python3
"""
Feature Importance Analysis with Random Forest and SHAP
Focuses on comparing feature importance patterns across different data types (RNASeq, dynamic, combined)
...
def main():
    """Main execution function for feature importance analysis"""
    ...
    exp_id = f"v1_rf_config1_shap_seeds{TOTAL_SEEDS}_batch{SEEDS_PER_BATCH}"
    ...
    with open(report_file, 'w', encoding='utf-8') as report:
        print_and_save("# Feature Importance Analysis Report (Random Forest + SHAP)", report)
        ...
        print_and_save("Analyzing feature importance patterns across different data types using Random Forest config1 and SHAP...", report)
    ...
    with open(report_file, 'a', encoding='utf-8') as report:
        ...
        rngs = list(np.random.RandomState(42).randint(0, 100000, size=TOTAL_SEEDS))
        ...
        print_and_save("Feature importance analysis with Random Forest and SHAP completed successfully!", report)
