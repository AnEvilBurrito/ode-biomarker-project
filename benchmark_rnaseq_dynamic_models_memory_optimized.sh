...
PYTHON_SCRIPT="/home/dawsonlan/ode-biomarker-project/benchmark_rnaseq_dynamic_models_memory_optimized.py"
...
echo "Running RNASeq + dynamic features benchmarking script..."
python "$PYTHON_SCRIPT"

# Check if the script ran successfully
if [ $? -eq 0 ]; then
    echo "RNASeq + dynamic features benchmarking completed successfully"
else
